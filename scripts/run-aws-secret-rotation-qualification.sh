...
evidence_path=${ARTIFACT_SERVER_AWS_ROTATION_EVIDENCE:-evidence/aws-secret-rotation.json}
product_evidence=${ARTIFACT_SERVER_AWS_ROTATION_PRODUCT_EVIDENCE:-evidence/aws-secret-rotation-product.json}
