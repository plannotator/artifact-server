...
**Companion documents:** [Artifact comments](./artifact-comments-spec.md), [Conformance ledger](./conformance.yml), research synthesis (`extension-research/alignment-study.md`), consultant packet (`extension-research/`)
...
Owner decisions this spec is built on (recorded in `extension-research/alignment-study.md` §6):
