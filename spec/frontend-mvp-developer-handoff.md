...
1. `AGENTS.md`
2. `spec/artifact-server-product-spec.md`
3. `spec/conformance.yml`
4. `README.md`
5. `spec/phase-8-project-scoped-artifacts.md`
6. `spec/decisions/0004-installation-identity-and-login.md`
...
If the UI implements a promise that is indexed in `spec/conformance.yml`, add
