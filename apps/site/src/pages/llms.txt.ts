...
export async function GET() {
  ...
  lines.push(
    ...
    "- [Artifact Server source](https://github.com/plannotator/artifact-server) — Open-source implementation (MIT OR Apache-2.0), specifications, and deployment packages.",
