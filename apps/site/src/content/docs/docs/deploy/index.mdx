...
Artifact Server `v0.1.0` is available as `ghcr.io/plannotator/artifact-server:v0.1.0`. Pin a production deployment to the immutable image reference in the release asset named `image-reference.txt`.
</Aside>
